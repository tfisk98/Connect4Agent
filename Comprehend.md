...
'env.agent_iter()' est une liste de la forme ['player_0', 'player_1', 'player_0', 'player_1', ... ] sur laequelle on itere au cours d'une partie afin de connaitre le joueur/l'agent dont c'est le tour.
'env.step(action)' place un jeton dans la grille de l'agent en train de jouer (index 0 de la 3ième dimension de la grille de jeu pour 'agent_0', index 1 pour l'autre 'agent_1' ), en placant un 1 aux index correspondants (1ère dimension de la grille de jeu pour le premier index, 2ieme dimension pour le second ). 
